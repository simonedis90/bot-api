...
export const scraperRepository = [
  {
    ...
    useFactory: (connection: Connection) =>
      connection.getRepository(LeagueEntity),
    inject: ['DATABASE_CONNECTION'],
  },
  {
    provide: TEAM_REPOSITORY,
    useFactory: (connection: Connection) =>
      connection.getRepository(TeamEntity),
    inject: ['DATABASE_CONNECTION'],
  },
  {
  ...
  },
  {
    ...
    useFactory: (connection: Connection) =>
      connection.getRepository(LeagueConfigEntity),
    inject: ['DATABASE_CONNECTION'],
  },
  {
    provide: STATS_REPOSITORY,
    useFactory: (connection: Connection) =>
      connection.getRepository(StatsEntity),
    inject: ['DATABASE_CONNECTION'],
  },
  {
  ...
  },
  {
    ...
    useFactory: (connection: Connection) =>
      connection.getRepository(ScrapMatchEntity),
    inject: ['DATABASE_CONNECTION'],
  },
  {
  ...
  },
  {
    ...
    useFactory: (connection: Connection) =>
      connection.getRepository(EventEntity),
    inject: ['DATABASE_CONNECTION'],
  },
  {
    provide: EVENT_CONFIG_REPOSITORY,
    useFactory: (connection: Connection) =>
      connection.getRepository(EventConfigEntity),
    inject: ['DATABASE_CONNECTION'],
  },
  {
    provide: PROVIDER_REWRITE_TEAM,
    useFactory: (connection: Connection) =>
      connection.getRepository(ProviderRewriteTeam),
    inject: ['DATABASE_CONNECTION'],
  },
  {
    provide: PROVIDER_REWRITE_LEAGUE,
    useFactory: (connection: Connection) =>
      connection.getRepository(ProviderRewriteLeague),
    inject: ['DATABASE_CONNECTION'],
  },
];
